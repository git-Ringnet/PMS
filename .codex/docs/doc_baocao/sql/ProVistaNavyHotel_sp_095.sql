...
CREATE   proc [dbo].[sp_095]
	...
	@date date
	 ...
	 as
		...
		select @division + cast(vw.BookingId as varchar(20)) + ' - ' + vw.BookingName as BookingId,dk.ma AS BookingId2,vw.BookingName ,vw.Company, case when ServiceId = 'RM' then vw.Room else null end as Room, vw.CustomerId,
