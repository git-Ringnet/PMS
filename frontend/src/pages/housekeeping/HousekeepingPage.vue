...
const tabs = computed(() => [
  ...
  { key: 'minibar', label: t('menu.minibar'), icon: Receipt, component: PostBillHousekeepingTab, group: 'service' },
  { key: 'laundry', label: t('menu.laundry'), icon: Receipt, component: PostBillHousekeepingTab, group: 'service' },
  { key: 'compensation', label: t('menu.compensation'), icon: Receipt, component: PostBillHousekeepingTab, group: 'service' },
