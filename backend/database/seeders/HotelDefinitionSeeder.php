...
class HotelDefinitionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $configs = [
            ...
            ['name' => 'RoleUserCancelCheckIn', 'value' => '', 'description' => 'Danh sach job_title_code/job_title duoc huy nhan phong tai Le tan, ngan cach bang dau phay.', 'is_visible' => true],
            ...
            ['name' => 'RoomPlan_ColorOOO', 'value' => '#3b82f6', 'description' => 'màu phòng khóa OOO', 'is_visible' => true],
            ['name' => 'RoomPlan_ColorOOS', 'value' => '#94a3b8', 'description' => 'màu phòng khóa OOS', 'is_visible' => true],
