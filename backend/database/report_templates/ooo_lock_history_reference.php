...
return new class
{
    ...
    {
        return [
            'report' => 'OOO_LOCK_HISTORY_STANDARD',
            'name' => 'Báo cáo lịch sử khóa phòng OOO',
            'page_size' => 'A4',
        ...
        return [
            'header' => [
                ...
                [
                    'id' => 'ooo_title',
                    'type' => 'text',
                    'content' => '<h1 style="text-align: center; font-size: 18px; font-weight: bold; margin: 4px 0 2px 0; text-transform: uppercase;">BÁO CÁO LỊCH SỬ KHÓA PHÒNG OOO</h1>',
            ...
            'detail' => [[
                'id' => 'ooo_lock_history_table',
                'type' => 'table',
                'dataSource' => 'rows',
                'tableType' => 'dynamic',
                'tableStyle' => 'grid',
                'tableClassName' => 'ooo-lock-table',
    ...
    public function html(): string
    {
        ...
        $html .= '<h1 style="text-align: center; font-size: 18px; font-weight: bold; margin: 4px 0 2px 0; text-transform: uppercase;">BÁO CÁO LỊCH SỬ KHÓA PHÒNG OOO</h1>'."\n";
        ...
        $html .= '<table class="ooo-lock-table">'."\n";
        $html .= '  <colgroup>'."\n";
...
.ooo-lock-table .group-title-cell {
    font-weight: bold;
    color: #000000;
...
.ooo-lock-table .pms-group-header td {
    background-color: #ffffff;
    border: 1px solid #c8c8c8;
}
.ooo-lock-table .pms-group-footer td,
.ooo-lock-table .pms-group-custom-row td {
    background-color: #dee2ed;
    font-weight: bold;
    border: 1px solid #c8c8c8;
}
.ooo-lock-table .note-cell {
