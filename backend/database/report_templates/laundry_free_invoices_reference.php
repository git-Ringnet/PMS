...
return new class
{
    ...
    {
        return [
            'report' => 'LAUNDRY_FREE_INVOICES_REFERENCE',
            'name' => 'Báo cáo hóa đơn giặt ủi miễn phí - Mẫu tham chiếu',
            'page_size' => 'A4',
    ...
    {
        return <<<'HTML'
<div class="report-header"><div class="hotel-header"><div class="hotel-logo">{{hotel.logo}}</div><div class="hotel-information"><div><b>Địa chỉ:</b> {{hotel.address}}</div><div><b>Người dùng:</b> {{report.generated_by}} <b class="date-label">Ngày:</b> {{report.generated_at}}</div></div></div><hr class="header-divider"><h1>BÁO CÁO HÓA ĐƠN GIẶT ỦI MIỄN PHÍ</h1><p class="report-period"><b>Ngày:</b> {{parameters.p_from_date}} &nbsp; ~ &nbsp; {{parameters.p_to_date}}</p></div>
...
HTML;
    ...
    public function blocks(): array
    {
        return [
            'header' => [
                ['id' => 'laundry_free_invoices_hotel_header', 'type' => 'text', 'content' => '<div class="hotel-header"><div class="hotel-logo">{{hotel.logo}}</div><div class="hotel-information"><div><b>Địa chỉ:</b> {{hotel.address}}</div><div><b>Người dùng:</b> {{report.generated_by}} <b class="date-label">Ngày:</b> {{report.generated_at}}</div></div></div>', 'style' => ['marginBottom' => '4px']],
                ['id' => 'laundry_free_invoices_divider', 'type' => 'divider', 'content' => '<hr class="header-divider">', 'style' => ['marginBottom' => '8px']],
                ['id' => 'laundry_free_invoices_title', 'type' => 'text', 'content' => '<h1>BÁO CÁO HÓA ĐƠN GIẶT ỦI MIỄN PHÍ</h1>', 'style' => ['textAlign' => 'center']],
                ['id' => 'laundry_free_invoices_period', 'type' => 'text', 'content' => '<p class="report-period"><b>Ngày:</b> {{parameters.p_from_date}} &nbsp; ~ &nbsp; {{parameters.p_to_date}}</p>', 'style' => ['textAlign' => 'center', 'marginBottom' => '10px']],
            ],
            'detail' => [
                [
                    'id' => 'laundry_free_invoices_table',
                    'type' => 'table',
                    'dataSource' => 'rows',
                    'tableType' => 'dynamic',
                    'tableStyle' => 'grid',
                    'groups' => [[
                        'id' => 'laundry_free_invoices_date_group',
                        'field' => 'DateGroup',
    ...
    {
        return <<<'CSS'
body{color:#0f172a;font-family:Arial,Helvetica,sans-serif;font-size:9px;max-width:210mm;margin:0 auto}.hotel-header{display:grid;grid-template-columns:175px 1fr;align-items:center;min-height:65px}.hotel-logo{display:flex;align-items:center;min-height:55px}.hotel-logo img{max-width:120px;max-height:55px;object-fit:contain}.hotel-information{line-height:1.8}.header-divider{margin:0 0 10px;border:0;border-top:1px solid #cbd5e1}h1{margin:0;text-align:center;font-size:18px}.report-period{margin:8px 0 12px;text-align:center}.laundry-free-invoices-table,#laundry_free_invoices_table table,.laundry-free-product-summary,#laundry_free_product_summary_table table{width:100%;border-collapse:collapse;table-layout:fixed}.laundry-free-invoices-table th,.laundry-free-invoices-table td,#laundry_free_invoices_table th,#laundry_free_invoices_table td,.laundry-free-product-summary th,.laundry-free-product-summary td,#laundry_free_product_summary_table th,#laundry_free_product_summary_table td{border:1px solid #cbd5e1;padding:4px 3px;line-height:1.15;vertical-align:middle;overflow-wrap:anywhere}.laundry-free-invoices-table th,.laundry-free-product-summary th,#laundry_free_invoices_table th,#laundry_free_product_summary_table th{background:#e2e8f0;color:#334155;text-align:center}.laundry-free-invoices-table .date-group,#laundry_free_invoices_table .date-group{background:#f8fafc;color:#334155;font-weight:bold;text-align:left!important}.laundry-free-invoices-table .invoice-total-row td,#laundry_free_invoices_table .invoice-total-row td{background:#f1f5f9;font-weight:bold}.laundry-free-invoices-table .invoice-total-row td:first-child,#laundry_free_invoices_table .invoice-total-row td:first-child{text-align:center}.laundry-free-invoices-table td:nth-child(1),.laundry-free-invoices-table td:nth-child(3),.laundry-free-invoices-table td:nth-child(10),.laundry-free-invoices-table td:nth-child(13),#laundry_free_invoices_table td:nth-child(1),#laundry_free_invoices_table td:nth-child(3),#laundry_free_invoices_table td:nth-child(10),#laundry_free_invoices_table td:nth-child(13),.laundry-free-product-summary td:nth-child(2),#laundry_free_product_summary_table td:nth-child(2){text-align:center}.laundry-free-invoices-table td:nth-child(7),.laundry-free-invoices-table td:nth-child(8),.laundry-free-invoices-table td:nth-child(9),#laundry_free_invoices_table td:nth-child(7),#laundry_free_invoices_table td:nth-child(8),#laundry_free_invoices_table td:nth-child(9),.laundry-free-product-summary td:nth-child(3),#laundry_free_product_summary_table td:nth-child(3){text-align:right;white-space:nowrap}.product-summary-title{margin:28px 0 20px;text-align:center;font-size:18px}.laundry-free-product-summary,#laundry_free_product_summary_table table{width:60%;margin:0 auto}.laundry-free-product-summary td,#laundry_free_product_summary_table td{min-height:22px}@media print{thead{display:table-header-group}tr{break-inside:avoid}}
CSS;
    }
