...
return new class
{
    ...
    {
        return [
            'report' => 'BREAKAGE_FREE_INVOICES_REFERENCE',
            'name' => 'Báo cáo hóa đơn hàng bể vỡ miễn phí - Mẫu tham chiếu',
            'page_size' => 'A4',
...
HTML;
    ...
    public function blocks(): array
    {
        return [
            'header' => [
                ['id' => 'BREAKAGE_FREE_INVOICES_hotel_header', 'type' => 'text', 'content' => '<div class="hotel-header"><div class="hotel-logo">{{hotel.logo}}</div><div class="hotel-information"><div><b>Địa chỉ:</b> {{hotel.address}}</div><div><b>Người dùng:</b> {{report.generated_by}} <b class="date-label">Ngày:</b> {{report.generated_at}}</div></div></div>', 'style' => ['marginBottom' => '4px']],
                ['id' => 'BREAKAGE_FREE_INVOICES_divider', 'type' => 'divider', 'content' => '<hr class="header-divider">', 'style' => ['marginBottom' => '8px']],
                ['id' => 'BREAKAGE_FREE_INVOICES_title', 'type' => 'text', 'content' => '<h1>BÁO CÁO HÓA ĐƠN HÀNG BỂ VỠ MIỄN PHÍ</h1>', 'style' => ['textAlign' => 'center']],
                ['id' => 'BREAKAGE_FREE_INVOICES_period', 'type' => 'text', 'content' => '<p class="report-period"><b>Ngày:</b> {{parameters.p_from_date}} &nbsp; ~ &nbsp; {{parameters.p_to_date}}</p>', 'style' => ['textAlign' => 'center', 'marginBottom' => '10px']],
            ],
            'detail' => [
                [
                    'id' => 'BREAKAGE_FREE_INVOICES_table',
                    'type' => 'table',
                    'dataSource' => 'rows',
                    'tableType' => 'dynamic',
                    'tableStyle' => 'grid',
                    'groups' => [[
                        'id' => 'BREAKAGE_FREE_INVOICES_date_group',
                        'field' => 'DateGroup',
                ...
                ['id' => 'laundry_free_product_summary_title', 'type' => 'text', 'content' => '<h2 class="product-summary-title">BẢNG KÊ THEO SẢN PHẨM</h2>'],
                [
                    'id' => 'laundry_free_product_summary_table',
                    'type' => 'table',
    ...
    {
        return <<<'CSS'
body{color:#0f172a;font-family:Arial,Helvetica,sans-serif;font-size:9px;max-width:210mm;margin:0 auto}.hotel-header{display:grid;grid-template-columns:175px 1fr;align-items:center;min-height:65px}.hotel-logo{display:flex;align-items:center;min-height:55px}.hotel-logo img{max-width:120px;max-height:55px;object-fit:contain}.hotel-information{line-height:1.8}.header-divider{margin:0 0 10px;border:0;border-top:1px solid #cbd5e1}h1{margin:0;text-align:center;font-size:18px}.report-period{margin:8px 0 12px;text-align:center}.laundry-free-invoices-table,#BREAKAGE_FREE_INVOICES_table table,.laundry-free-product-summary,#laundry_free_product_summary_table table{width:100%;border-collapse:collapse;table-layout:fixed}.laundry-free-invoices-table th,.laundry-free-invoices-table td,#BREAKAGE_FREE_INVOICES_table th,#BREAKAGE_FREE_INVOICES_table td,.laundry-free-product-summary th,.laundry-free-product-summary td,#laundry_free_product_summary_table th,#laundry_free_product_summary_table td{border:1px solid #cbd5e1;padding:4px 3px;line-height:1.15;vertical-align:middle;overflow-wrap:anywhere}.laundry-free-invoices-table th,.laundry-free-product-summary th,#BREAKAGE_FREE_INVOICES_table th,#laundry_free_product_summary_table th{background:#e2e8f0;color:#334155;text-align:center}.laundry-free-invoices-table .date-group,#BREAKAGE_FREE_INVOICES_table .date-group{background:#f8fafc;color:#334155;font-weight:bold;text-align:left!important}.laundry-free-invoices-table .invoice-total-row td,#BREAKAGE_FREE_INVOICES_table .invoice-total-row td{background:#f1f5f9;font-weight:bold}.laundry-free-invoices-table .invoice-total-row td:first-child,#BREAKAGE_FREE_INVOICES_table .invoice-total-row td:first-child{text-align:center}.laundry-free-invoices-table td:nth-child(1),.laundry-free-invoices-table td:nth-child(3),.laundry-free-invoices-table td:nth-child(10),.laundry-free-invoices-table td:nth-child(13),#BREAKAGE_FREE_INVOICES_table td:nth-child(1),#BREAKAGE_FREE_INVOICES_table td:nth-child(3),#BREAKAGE_FREE_INVOICES_table td:nth-child(10),#BREAKAGE_FREE_INVOICES_table td:nth-child(13),.laundry-free-product-summary td:nth-child(2),#laundry_free_product_summary_table td:nth-child(2){text-align:center}.laundry-free-invoices-table td:nth-child(7),.laundry-free-invoices-table td:nth-child(8),.laundry-free-invoices-table td:nth-child(9),#BREAKAGE_FREE_INVOICES_table td:nth-child(7),#BREAKAGE_FREE_INVOICES_table td:nth-child(8),#BREAKAGE_FREE_INVOICES_table td:nth-child(9),.laundry-free-product-summary td:nth-child(3),#laundry_free_product_summary_table td:nth-child(3){text-align:right;white-space:nowrap}.product-summary-title{margin:28px 0 20px;text-align:center;font-size:18px}.laundry-free-product-summary,#laundry_free_product_summary_table table{width:60%;margin:0 auto}.laundry-free-product-summary td,#laundry_free_product_summary_table td{min-height:22px}@media print{thead{display:table-header-group}tr{break-inside:avoid}}
CSS;
    }
