...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::unprepared($this->procedureSql(excludeCityLedger: true));
    }
    ...
    public function down(): void
    {
        ...
        DB::unprepared('DROP PROCEDURE IF EXISTS rpt_deposits_sale');
        DB::unprepared($this->procedureSql(excludeCityLedger: false));
    }

    private function procedureSql(bool $excludeCityLedger): string
    {
        $cityLedgerFilter = $excludeCityLedger
...
BEGIN
    WITH base AS (
        ...
        WHERE p.deleted_at IS NULL
          AND p.edit_flag = 0
{$cityLedgerFilter}          AND p.date BETWEEN p_from_date AND p_to_date
