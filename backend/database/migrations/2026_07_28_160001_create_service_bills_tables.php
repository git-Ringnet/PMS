...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('service_bill_details', function (Blueprint $table) {
            ...
            $table->string('Pack2', 50)->nullable();
            $table->string('Pack3', 500)->nullable();
            $table->decimal('DetailBillOriginalAmount', 15, 2)->nullable();
            $table->decimal('DiscountAmount', 15, 2)->default(0);
            $table->decimal('IncreaseAmount', 15, 2)->default(0);
            $table->unsignedBigInteger('VatId')->nullable();
        ...
        Schema::create('housekeeping_service_bills', function (Blueprint $table) {
            ...
            $table->decimal('BillOriginalAmount', 15, 2)->default(0);
            $table->decimal('BillDiscountAmount', 15, 2)->default(0);
            $table->decimal('BillAmount', 15, 2)->default(0);
